...
/**
 * Parser for cards-solutions block
 *
 ...
 *   <div class="teaser-cards-block cmp-cards-container cmp-teaser">
 *     <div class="cmp-teaser__content">
 *       <p class="cmp-teaser__pretitle">Intelligent solutions...</p>
 *     </div>
 ...
 *           <div class="cmp-teaser__content">
 *             <h2 class="cmp-teaser__title">Infrastructure</h2>
 *             <div class="cmp-teaser__description"><p>...</p></div>
 *             <div class="cmp-teaser__action-container"><a>View services</a></div>
 *           </div>
 *           <div class="cmp-teaser__image"><img></div>
 *         </div>
 *       </div>
...
export default function parse(element, { document }) {
  ...
  // VALIDATED: Found <div class="card"> inside <div class="cards wrapper"> (line 2752)
  const cards = element.querySelectorAll('.cards.wrapper > .card');

  cards.forEach((card) => {
    // Extract image
    // VALIDATED: Found <div class="cmp-teaser__image"><div class="cmp-image"><img> (line 2765)
    ...
    // Extract title
    // VALIDATED: Found <h2 class="cmp-teaser__title">Infrastructure</h2> (line 2755)
    const title = card.querySelector('.cmp-teaser__title');
    if (title) contentDiv.append(title);

    // Extract description
    // VALIDATED: Found <div class="cmp-teaser__description"><p>...</p></div> (line 2758)
    const desc = card.querySelector('.cmp-teaser__description');
    if (desc) contentDiv.append(desc);

    // Extract CTA
    // VALIDATED: Found <a class="cmp-teaser__action-link">View services</a> (line 2762)
